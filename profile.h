...
struct table_config
{
    QString main_criteria;
    QString secondary_criteria;
    QString lower_tolerance_limit;
    QString lower_limit_of_warning;
    QString upper_limit_of_warning;
    QString reasonable_upper_limit;
    QString result;
    QString unit;
    QString limiting_value;
    QString Harm_count;

    QString criterion_name;
    QString profile_data;
...
namespace profile_arguments {

    struct profile_filter
    {
        QString filter;

    };

    struct profile_order
    {
        QString partNumber;
        QString partName;
        QString Number_of_pieces;
    };
